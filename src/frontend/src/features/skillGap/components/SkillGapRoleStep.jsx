      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm font-semibold leading-6 text-slate-600">
            Select a career role, then choose one published roadmap. The checklist will include every skill configured in that roadmap.
          </p>
        </div>
      </div>

      <div className="mt-6 grid gap-5 lg:grid-cols-2">
        <div className="rounded-2xl border border-[#B9D8CC]/80 bg-[#F7F1E8]/50 p-4">
