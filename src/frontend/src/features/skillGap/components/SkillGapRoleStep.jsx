...
import { getAssessmentLevelStyle } from "../utils/skillGapUtils";
    ...
    <section className="rounded-2xl border border-[#B9D8CC]/80 bg-white/95 p-5 shadow-sm">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <h2 className="mt-1 text-xl font-extrabold text-[#18332D]">
            Choose target role and assessment level
          </h2>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="mt-6 rounded-xl border border-dashed border-[#B9D8CC] bg-[#F7F1E8]/60 p-8 text-center text-sm font-bold text-slate-600">
          No career roles were returned by the backend. Check seed data for
          CareerRoles.
        </div>
      ) : (
          ...
          {roles.map((role) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mt-4 text-sm font-extrabold text-[#18332D]">
                  {role.name}
                </h3>
              </button>
            );
                ...
                return (
                  ...
                  >
                    ...
                    <p className="mt-3 text-xs font-bold leading-5 text-slate-600">
                      {level.groupCount === null ||
                      level.groupCount === undefined
