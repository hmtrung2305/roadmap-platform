    ...
    <div className={`flex min-w-0 ${isUser ? "justify-end" : "justify-start"}`}>
      ...
      >
        {isUser ? (
          ...
          <div className="prose prose-slate max-w-none prose-p:my-1 prose-ul:my-1 prose-ol:my-1 prose-pre:my-2 prose-pre:rounded-lg prose-pre:bg-[#18332D] prose-code:text-xs prose-a:text-[#1F6F5F]">
