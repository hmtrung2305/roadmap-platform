...
import { getEdgeStyle, getNodeTypeClass, getStatusColor } from "../roadmap/roadmapUtils";
...
const previewEdges = [
  // Top layer edges
  { id: "html-1", edgeType: "choice", d: "M168 91 H180 C188 91 188 162 194 162" },
  { id: "html-2", edgeType: "choice", d: "M168 161 H180 C188 161 188 162 194 162" },
  { id: "html-3", edgeType: "choice", d: "M168 231 H180 C188 231 188 162 194 162" },
  { id: "html-to-phase", edgeType: "sequence", d: "M350 162 H388" },
  { id: "phase-to-right", edgeType: "sequence", d: "M564 160 H600" },
  { id: "right-to-a11y", edgeType: "choice", d: "M760 162 H776 C784 162 784 115 792 115" },
  { id: "right-to-seo", edgeType: "choice", d: "M760 162 H776 C784 162 784 209 792 209" },
  ...
  // Middle layer edges
  { id: "flex-to-group", edgeType: "choice", d: "M168 307 H180 C188 307 188 348 194 348" },
  { id: "breakpoint-to-group", edgeType: "choice", d: "M168 379 H180 C188 379 188 348 194 348" },
  { id: "group-to-responsive-phase", edgeType: "sequence", d: "M350 348 H388" },
  { id: "responsive-phase-to-project", edgeType: "sequence", d: "M564 348 H602" },

  // Bottom layer edges
  { id: "practice-phase-to-group", edgeType: "sequence", d: "M564 531 H600" },
  { id: "practice-1", edgeType: "choice", d: "M760 532 H776 C784 532 784 485 792 485" },
  { id: "practice-2", edgeType: "choice", d: "M760 532 H776 C784 532 784 579 792 579" },
];
      ...
      <div className="relative z-10 shrink-0">
        ...
        <div className="mt-4 max-w-sm">
          ...
          <p className="mt-2 text-xs leading-5 text-slate-600">
            A subtle preview of how TechMap connects phases, choices, and practice tasks.
          </p>
        </div>
      </div>
          ...
          {previewEdges.map((edge) => {
            ...
            return (
              <path
                ...
                d={edge.d}
                stroke={style.stroke}
                strokeWidth={Math.max((Number.parseFloat(style.strokeWidth) || 2) * 0.52, 1.05)}
...
function formatAuthSelectionText(node) {
  if (node.selectionType === "choose_many") return `choose ${node.requiredCount || 1}`;
