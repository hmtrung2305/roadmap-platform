...
const verificationConfig = {
  [VERIFICATION_PURPOSES.REGISTER]: {
    ...
    resendEndpoint: "/auth/registration/resend-verification",
  ...
  [VERIFICATION_PURPOSES.LINK_LOCAL]: {
    ...
    endpoint: "/me/auth-providers/local/verify",
    resendEndpoint: "/me/auth-providers/local/resend-verification",
    verifyBody: ({ otp }) => ({ otp }),
    resendBody: () => null,
    requiresEmail: false,
  ...
  [VERIFICATION_PURPOSES.CHANGE_EMAIL]: {
    ...
    endpoint: "/me/auth-providers/local/email/verify",
    resendEndpoint: null,
    verifyBody: ({ otp }) => ({ otp }),
    resendBody: () => null,
    requiresEmail: false,
