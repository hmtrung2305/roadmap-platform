          ...
          <div className="overflow-hidden rounded-t-lg">
            <div className="relative h-50 bg-indigo-50">
              ...
              <button
                ...
                className="absolute right-5 top-5 inline-flex h-10 items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50"
              >
                <Edit3 size={16} />
                Edit profile
              </button>
          ...
          <div className="px-6 pb-3">
            <div className="-mt-12 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
                <div className="relative z-10 h-24 w-24 shrink-0 overflow-hidden rounded-lg border-4 border-white bg-indigo-50 shadow-md">
                  {profile?.avatarUrl ? (
                    <img
            ...
            {profile?.bio ? (
              ...
              <div className="mt-6 rounded-lg border border-dashed border-slate-200 bg-slate-50 px-4 py-4 text-sm text-slate-500">
...
function LinkItem({ icon, label, url }) {
  if (!url) {
    return (
      <div className="flex items-center gap-3 rounded-lg bg-slate-50 px-4 py-3 text-sm text-slate-400">
        <span>{icon}</span>
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="flex items-center gap-3 rounded-lg bg-indigo-50 px-4 py-3 text-sm font-semibold text-indigo-700 transition hover:bg-indigo-100"
    >
      <span>{icon}</span>
      <span>{label}</span>
    </a>
