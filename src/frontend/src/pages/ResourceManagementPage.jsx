...
export default function ResourceManagementPage() {
  ...
  return (
    <main className="tm-page min-h-screen px-6 py-12">
      <div className="mx-auto max-w-7xl space-y-6">
        <header className="tm-surface tm-soft-enter overflow-hidden">
        ...
        <section>
          ...
          {isFetching ? (
            <div className="tm-surface p-10 text-center text-sm text-slate-500">
              Loading documents...
            </div>
          ) : (
            <ResourceGrid
...
function Metric({ label, value }) {
  return (
    <div className="tm-surface tm-surface-hover bg-[#F7F1E8]/60 px-4 py-3">
