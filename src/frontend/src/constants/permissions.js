export const PERMISSIONS = Object.freeze({
  ...
  SKILL_CREATE_CATALOG: "skill.create.catalog",
  SKILL_UPDATE_CATALOG: "skill.update.catalog",
  LEARNING_RESOURCE_VIEW_CATALOG: "learning_resource.view.catalog",
  LEARNING_RESOURCE_CREATE_CATALOG: "learning_resource.create.catalog",
  LEARNING_RESOURCE_UPDATE_CATALOG: "learning_resource.update.catalog",
  ...
  ROADMAP_REVIEW_REJECT_ANY: "roadmap_review.reject.any",
...
export const CONTENT_MANAGER_SURFACE_PERMISSIONS = Object.freeze([
  ...
  PERMISSIONS.LEARNING_MODULE_UPDATE_OWN,
  PERMISSIONS.LEARNING_MODULE_DELETE_OWN,
  PERMISSIONS.LEARNING_MODULE_PUBLISH_OWN,
  PERMISSIONS.LEARNING_MODULE_ARCHIVE_OWN,
  PERMISSIONS.LEARNING_MODULE_PREVIEW_OWN,
  PERMISSIONS.ROADMAP_DRAFT_VIEW_OWN,
  PERMISSIONS.ROADMAP_DRAFT_CREATE_OWN,
  PERMISSIONS.ROADMAP_DRAFT_UPDATE_OWN,
  PERMISSIONS.ROADMAP_DRAFT_DELETE_OWN,
  PERMISSIONS.ROADMAP_REVIEW_SUBMIT_OWN,
  PERMISSIONS.ROADMAP_REVIEW_VIEW_ANY,
  PERMISSIONS.ROADMAP_REVIEW_APPROVE_ANY,
  PERMISSIONS.ROADMAP_REVIEW_REJECT_ANY,
  ...
  PERMISSIONS.SKILL_GAP_CONFIG_UPDATE_ANY,
]);
