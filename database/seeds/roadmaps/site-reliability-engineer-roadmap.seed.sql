...
('proj-monitored-service-deployment', 'grp-containers-and-kubernetes-core-practice', 3, 'project', NULL, NULL, NULL, 'Monitored Service Deployment', 'Milestone project brief: Build a portfolio-ready deliverable for monitored service deployment with implementation notes, verification evidence, and a concise explanation of tradeoffs. Build a reviewable portfolio evidence package that demonstrates the main decisions from Kubernetes Operations Practice. Expected evidence includes a reviewable package of project evidence, clear presentation notes or README sections, and links, screenshots, or summaries that explain the work. Keep scope focused so the result can be completed, checked, and explained.', 'This required milestone project turns the surrounding Site Reliability Engineer topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'checkpoint', 'grp-containers-and-kubernetes-core-practice-projects', 5, 1, 7, 'intermediate', 90, 500, 3770, '{"role": "site-reliability-engineer","nodeKey": "proj-monitored-service-deployment","project": true,"projectPurpose": "milestone_practice","projectKind": "portfolio_review","projectScope": "focused_milestone","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["select the evidence to include","organize it into a readable package","explain the role of each artifact","record gaps and next improvements"],"expectedEvidence": ["a reviewable package of project evidence","clear presentation notes or README sections","links, screenshots, or summaries that explain the work"],"optionalPractice": false,"milestone": true}'::jsonb, true, true, '["Build a focused Monitored Service Deployment artifact that demonstrates the main concepts from Kubernetes Operations Practice.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a reviewable package of project evidence, clear presentation notes or README sections, and links, screenshots, or summaries that explain the work.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
('proj-incident-response-simulation', 'grp-incident-response-and-on-call-readiness-core-practice', 3, 'project', NULL, NULL, NULL, 'Incident Response Simulation', 'Milestone project brief: Build a portfolio-ready deliverable for incident response simulation with implementation notes, verification evidence, and a concise explanation of tradeoffs. Build a reviewable portfolio evidence package that demonstrates the main decisions from Runbooks and Postmortems. Expected evidence includes a reviewable package of project evidence, clear presentation notes or README sections, and links, screenshots, or summaries that explain the work. Keep scope focused so the result can be completed, checked, and explained.', 'This required milestone project turns the surrounding Site Reliability Engineer topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'checkpoint', 'grp-incident-response-and-on-call-readiness-core-practice-projects', 8, 1, 7, 'intermediate', 90, 500, 5510, '{"role": "site-reliability-engineer","nodeKey": "proj-incident-response-simulation","project": true,"projectPurpose": "milestone_practice","projectKind": "portfolio_review","projectScope": "focused_milestone","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["select the evidence to include","organize it into a readable package","explain the role of each artifact","record gaps and next improvements"],"expectedEvidence": ["a reviewable package of project evidence","clear presentation notes or README sections","links, screenshots, or summaries that explain the work"],"optionalPractice": false,"milestone": true}'::jsonb, true, true, '["Build a focused Incident Response Simulation artifact that demonstrates the main concepts from Runbooks and Postmortems.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a reviewable package of project evidence, clear presentation notes or README sections, and links, screenshots, or summaries that explain the work.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
('proj-slo-and-error-budget-report', 'grp-reliability-engineering-and-slos-core-practice', 3, 'project', NULL, NULL, NULL, 'SLO and Error Budget Report', 'Milestone project brief: Build a portfolio-ready deliverable for slo and error budget report with implementation notes, verification evidence, and a concise explanation of tradeoffs. Build a reviewable portfolio evidence package that demonstrates the main decisions from Reliability Tradeoff Practice. Expected evidence includes a reviewable package of project evidence, clear presentation notes or README sections, and links, screenshots, or summaries that explain the work. Keep scope focused so the result can be completed, checked, and explained.', 'This required milestone project turns the surrounding Site Reliability Engineer topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'checkpoint', 'grp-reliability-engineering-and-slos-core-practice-projects', 9, 1, 7, 'intermediate', 90, 500, 6090, '{"role": "site-reliability-engineer","nodeKey": "proj-slo-and-error-budget-report","project": true,"projectPurpose": "milestone_practice","projectKind": "portfolio_review","projectScope": "focused_milestone","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["select the evidence to include","organize it into a readable package","explain the role of each artifact","record gaps and next improvements"],"expectedEvidence": ["a reviewable package of project evidence","clear presentation notes or README sections","links, screenshots, or summaries that explain the work"],"optionalPractice": false,"milestone": true}'::jsonb, true, true, '["Build a focused SLO and Error Budget Report artifact that demonstrates the main concepts from Reliability Tradeoff Practice.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a reviewable package of project evidence, clear presentation notes or README sections, and links, screenshots, or summaries that explain the work.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
('proj-reliability-automation-script', 'grp-programming-and-automation-core-practice', 3, 'project', NULL, NULL, NULL, 'Reliability Automation Script', 'Milestone project brief: Build a portfolio-ready deliverable for reliability automation script with implementation notes, verification evidence, and a concise explanation of tradeoffs. Build a reviewable portfolio evidence package that demonstrates the main decisions from Operational Automation Practice. Expected evidence includes a reviewable package of project evidence, clear presentation notes or README sections, and links, screenshots, or summaries that explain the work. Keep scope focused so the result can be completed, checked, and explained.', 'This required milestone project turns the surrounding Site Reliability Engineer topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'checkpoint', 'grp-programming-and-automation-core-practice-projects', 3, 1, 7, 'intermediate', 90, 500, 2610, '{"role": "site-reliability-engineer","nodeKey": "proj-reliability-automation-script","project": true,"projectPurpose": "milestone_practice","projectKind": "portfolio_review","projectScope": "focused_milestone","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["select the evidence to include","organize it into a readable package","explain the role of each artifact","record gaps and next improvements"],"expectedEvidence": ["a reviewable package of project evidence","clear presentation notes or README sections","links, screenshots, or summaries that explain the work"],"optionalPractice": false,"milestone": true}'::jsonb, true, true, '["Build a focused Reliability Automation Script artifact that demonstrates the main concepts from Operational Automation Practice.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a reviewable package of project evidence, clear presentation notes or README sections, and links, screenshots, or summaries that explain the work.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
('proj-observability-dashboard', 'ph-observability-and-monitoring', 3, 'project', NULL, NULL, NULL, 'Observability Dashboard', 'Optional project brief: Build a portfolio-ready deliverable for observability dashboard with implementation notes, verification evidence, and a concise explanation of tradeoffs. Build a small, reviewable portfolio evidence package to practice ideas from Observability and Monitoring. Expected evidence includes a reviewable package of project evidence, clear presentation notes or README sections, and links, screenshots, or summaries that explain the work. Keep it lightweight; the goal is applied practice and clearer portfolio evidence, not a mandatory milestone.', 'This optional practice project turns the surrounding Site Reliability Engineer topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'side', 'ph-observability-and-monitoring-projects', 7, 1, 12, 'intermediate', 60, 920, 4790, '{"role": "site-reliability-engineer","nodeKey": "proj-observability-dashboard","project": true,"projectPurpose": "optional_practice","projectKind": "portfolio_review","projectScope": "small_practice_artifact","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["select the evidence to include","organize it into a readable package","explain the role of each artifact","record gaps and next improvements"],"expectedEvidence": ["a reviewable package of project evidence","clear presentation notes or README sections","links, screenshots, or summaries that explain the work"],"optionalPractice": true,"milestone": false}'::jsonb, false, true, '["Build a small Observability Dashboard artifact to practice selected concepts from Observability and Monitoring.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a reviewable package of project evidence, clear presentation notes or README sections, and links, screenshots, or summaries that explain the work.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
('proj-capacity-and-resilience-test', 'ph-performance-capacity-and-resilience', 3, 'project', NULL, NULL, NULL, 'Capacity and Resilience Test', 'Optional project brief: Build a portfolio-ready deliverable for capacity and resilience test with implementation notes, verification evidence, and a concise explanation of tradeoffs. Build a small, reviewable portfolio evidence package to practice ideas from Performance, Capacity, and Resilience. Expected evidence includes a reviewable package of project evidence, clear presentation notes or README sections, and links, screenshots, or summaries that explain the work. Keep it lightweight; the goal is applied practice and clearer portfolio evidence, not a mandatory milestone.', 'This optional practice project turns the surrounding Site Reliability Engineer topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'side', 'ph-performance-capacity-and-resilience-projects', 10, 1, 14, 'intermediate', 60, 920, 6570, '{"role": "site-reliability-engineer","nodeKey": "proj-capacity-and-resilience-test","project": true,"projectPurpose": "optional_practice","projectKind": "portfolio_review","projectScope": "small_practice_artifact","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["select the evidence to include","organize it into a readable package","explain the role of each artifact","record gaps and next improvements"],"expectedEvidence": ["a reviewable package of project evidence","clear presentation notes or README sections","links, screenshots, or summaries that explain the work"],"optionalPractice": true,"milestone": false}'::jsonb, false, true, '["Build a small Capacity and Resilience Test artifact to practice selected concepts from Performance, Capacity, and Resilience.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a reviewable package of project evidence, clear presentation notes or README sections, and links, screenshots, or summaries that explain the work.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
('proj-sre-capstone-with-runbook-and-postmortem', 'grp-sre-portfolio-capstone-core-practice', 2, 'project', NULL, NULL, NULL, 'SRE Capstone with Runbook and Postmortem', 'Capstone project brief: Build a portfolio-ready deliverable for sre capstone with runbook and postmortem with implementation notes, verification evidence, and a concise explanation of tradeoffs. Build it as an integrated deployment or operations lab for the Site Reliability Engineer roadmap, with enough scope to connect multiple earlier topics from SRE Capstone Delivery. Expected evidence includes configuration files or deployment steps, verification output such as logs, screenshots, or CLI results, and a rollback, cost, or security note. Keep the implementation reviewable: define the problem, show the working path, validate the result, and document limitations rather than claiming production readiness.', 'This capstone project turns the surrounding Site Reliability Engineer topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'checkpoint', 'grp-sre-portfolio-capstone-core-practice-projects', 12, 1, 7, 'advanced', 90, 500, 7830, '{"role": "site-reliability-engineer","nodeKey": "proj-sre-capstone-with-runbook-and-postmortem","project": true,"projectPurpose": "capstone","projectKind": "cloud_devops","projectScope": "integrated_multi_topic","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["choose a minimal deployment target","write the config or runbook","verify the environment end-to-end","record risks, rollback, and cost/security notes"],"expectedEvidence": ["configuration files or deployment steps","verification output such as logs, screenshots, or CLI results","a rollback, cost, or security note"],"optionalPractice": false,"milestone": true,"capstone": true}'::jsonb, true, true, '["Plan and build an integrated SRE Capstone with Runbook and Postmortem that connects multiple topics from the Site Reliability Engineer roadmap.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes configuration files or deployment steps, verification output such as logs, screenshots, or CLI results, and a rollback, cost, or security note.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement.","The project connects at least three earlier roadmap topics and explains how they interact."]'::jsonb),
