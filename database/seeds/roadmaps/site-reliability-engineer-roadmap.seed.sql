...
('chk-linux-networking-and-systems-foundations-review', 'grp-linux-networking-and-systems-foundations-core-practice', 3, 'checkpoint', 'review', NULL, NULL, 'Linux, Networking, and Systems Foundations Review', 'Review checkpoint for Networking for Production Services. The learner synthesizes completed topics such as HTTP, TLS, and Reverse Proxies, System Debugging Tools, records evidence, and updates the learning plan before continuing.', 'This checkpoint turns the phase boundary into a reflection and evidence-review step for the site reliability engineering roadmap rather than another unchecked content topic.', 'checkpoint', 'grp-linux-networking-and-systems-foundations-core-practice-checkpoints', 2, 1, 2, 'intermediate', 65, 500, 1990, '{"role": "site-reliability-engineer", "nodeKey": "chk-linux-networking-and-systems-foundations-review", "checkpointPurpose": "phase_review", "reviewMode": "review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Explain how topics from Networking for Production Services connect to realistic site reliability engineering work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
...
('chk-containers-and-kubernetes-review', 'grp-containers-and-kubernetes-core-practice', 4, 'checkpoint', 'review', NULL, NULL, 'Containers and Kubernetes Review', 'Review checkpoint for Kubernetes Operations Practice. The learner synthesizes completed topics such as Health Checks and Probes, Kubernetes Troubleshooting, Monitored Service Deployment, ConfigMaps, Secrets, and Rollout Safety, records evidence, and updates the learning plan before continuing.', 'This checkpoint turns the phase boundary into a reflection and evidence-review step for the site reliability engineering roadmap rather than another unchecked content topic.', 'checkpoint', 'grp-containers-and-kubernetes-core-practice-checkpoints', 5, 1, 2, 'intermediate', 65, 500, 3730, '{"role": "site-reliability-engineer", "nodeKey": "chk-containers-and-kubernetes-review", "checkpointPurpose": "phase_review", "reviewMode": "review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Explain how topics from Kubernetes Operations Practice connect to realistic site reliability engineering work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
...
('chk-ci-cd-and-release-engineering-review', 'grp-ci-cd-and-release-engineering-core-practice', 3, 'checkpoint', 'review', NULL, NULL, 'CI/CD and Release Engineering Review', 'Review checkpoint for Safe Deployment Practice. The learner synthesizes completed topics such as Artifact and Environment Promotion, Deployment Failure Analysis, Release Health Checks, Change Failure Review, records evidence, and updates the learning plan before continuing.', 'This checkpoint turns the phase boundary into a reflection and evidence-review step for the site reliability engineering roadmap rather than another unchecked content topic.', 'checkpoint', 'grp-ci-cd-and-release-engineering-core-practice-checkpoints', 6, 1, 2, 'intermediate', 65, 500, 4310, '{"role": "site-reliability-engineer", "nodeKey": "chk-ci-cd-and-release-engineering-review", "checkpointPurpose": "phase_review", "reviewMode": "review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Explain how topics from Safe Deployment Practice connect to realistic site reliability engineering work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
...
('chk-observability-and-monitoring-review', 'grp-observability-and-monitoring-core-practice', 4, 'checkpoint', 'review', NULL, NULL, 'Observability and Monitoring Review', 'Review checkpoint for Monitoring Dashboards and Alerts. The learner synthesizes completed topics such as Alert Design and Noise Reduction, Service Health Reviews, records evidence, and updates the learning plan before continuing.', 'This checkpoint turns the phase boundary into a reflection and evidence-review step for the site reliability engineering roadmap rather than another unchecked content topic.', 'checkpoint', 'grp-observability-and-monitoring-core-practice-checkpoints', 7, 1, 2, 'intermediate', 65, 500, 4890, '{"role": "site-reliability-engineer", "nodeKey": "chk-observability-and-monitoring-review", "checkpointPurpose": "phase_review", "reviewMode": "review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Explain how topics from Monitoring Dashboards and Alerts connect to realistic site reliability engineering work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
...
('chk-reliability-engineering-and-slos-review', 'grp-reliability-engineering-and-slos-core-practice', 4, 'checkpoint', 'review', NULL, NULL, 'Reliability Engineering and SLOs Review', 'Review checkpoint for Reliability Tradeoff Practice. The learner synthesizes completed topics such as Availability and Latency Targets, Customer Impact Analysis, SLO and Error Budget Report, Burn-Rate Alert Design, records evidence, and updates the learning plan before continuing.', 'This checkpoint turns the phase boundary into a reflection and evidence-review step for the site reliability engineering roadmap rather than another unchecked content topic.', 'checkpoint', 'grp-reliability-engineering-and-slos-core-practice-checkpoints', 9, 1, 2, 'intermediate', 65, 500, 6050, '{"role": "site-reliability-engineer", "nodeKey": "chk-reliability-engineering-and-slos-review", "checkpointPurpose": "phase_review", "reviewMode": "review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Explain how topics from Reliability Tradeoff Practice connect to realistic site reliability engineering work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
...
('chk-performance-capacity-and-resilience-review', 'grp-performance-capacity-and-resilience-core-practice', 4, 'checkpoint', 'review', NULL, NULL, 'Performance, Capacity, and Resilience Review', 'Review checkpoint for Failure Mode and Load Testing. The learner synthesizes completed topics such as Caching and CDN Strategy, Chaos and Failure Mode Testing, records evidence, and updates the learning plan before continuing.', 'This checkpoint turns the phase boundary into a reflection and evidence-review step for the site reliability engineering roadmap rather than another unchecked content topic.', 'checkpoint', 'grp-performance-capacity-and-resilience-core-practice-checkpoints', 10, 1, 2, 'intermediate', 65, 500, 6630, '{"role": "site-reliability-engineer", "nodeKey": "chk-performance-capacity-and-resilience-review", "checkpointPurpose": "phase_review", "reviewMode": "review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Explain how topics from Failure Mode and Load Testing connect to realistic site reliability engineering work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
...
('chk-security-and-compliance-awareness-review', 'grp-security-and-compliance-awareness-core-practice', 3, 'checkpoint', 'review', NULL, NULL, 'Security and Compliance Awareness Review', 'Review checkpoint for Compliance Evidence and Guardrails. The learner synthesizes completed topics such as Audit Evidence for Operations, Compliance-Friendly Runbooks, Production Access Review, Compliance Evidence for Operations, records evidence, and updates the learning plan before continuing.', 'This checkpoint turns the phase boundary into a reflection and evidence-review step for the site reliability engineering roadmap rather than another unchecked content topic.', 'checkpoint', 'grp-security-and-compliance-awareness-core-practice-checkpoints', 11, 1, 2, 'intermediate', 65, 500, 7210, '{"role": "site-reliability-engineer", "nodeKey": "chk-security-and-compliance-awareness-review", "checkpointPurpose": "phase_review", "reviewMode": "review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Explain how topics from Compliance Evidence and Guardrails connect to realistic site reliability engineering work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
...
('alert-quality-review', 'grp-telemetry-and-alerting-deepening', 4, 'checkpoint', 'review', NULL, NULL, 'Alert Quality Review', 'Review checkpoint for Telemetry and Alerting Deepening. The learner synthesizes completed topics such as SLI Instrumentation Patterns, Log Correlation and Trace Context, PromQL Query Patterns, records evidence, and updates the learning plan before continuing.', 'This checkpoint turns the phase boundary into a reflection and evidence-review step for the site reliability engineering roadmap rather than another unchecked content topic.', 'checkpoint', 'grp-telemetry-and-alerting-deepening-checkpoints', 3, 4, 2, 'intermediate', 85, 500, 5270, '{"addedIn": "v19-depth-expansion", "nodeKey": "alert-quality-review", "checkpointPurpose": "phase_review", "reviewMode": "review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Explain how topics from Telemetry and Alerting Deepening connect to realistic site reliability engineering work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
...
('sre-capstone-handoff-review', 'grp-sre-capstone-evidence-and-handoff', 3, 'checkpoint', 'review', NULL, NULL, 'SRE Capstone Handoff Review', 'Final roadmap checkpoint for SRE Capstone Evidence and Handoff. The learner reviews portfolio evidence, unresolved gaps, and next learning priorities across the site reliability engineering path.', 'This checkpoint closes the suggested site reliability engineering orientation path by organizing evidence and next steps. It is not an employment guarantee or formal competency certification.', 'checkpoint', 'grp-sre-capstone-evidence-and-handoff-checkpoints', 3, 3, 2, 'intermediate', 85, 500, 8125, '{"addedIn": "v19-depth-expansion", "nodeKey": "sre-capstone-handoff-review", "checkpointPurpose": "phase_review", "reviewMode": "final_review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Connect completed roadmap work to a coherent site reliability engineering learning narrative.", "Review portfolio or project evidence and identify which artifacts are ready to share.", "Define remaining gaps and future specialization priorities."]'::jsonb, '["Summarize completed phases, projects, and major skill groups.", "Attach or reference portfolio evidence, project links, diagrams, reports, tests, or notes where available.", "List remaining gaps or specialization topics for future learning.", "State that the checkpoint is a planning review, not proof of job readiness."]'::jsonb)
;
