...
('analytical-thinking', 'Analytical Thinking', 'Analytical Foundations & Data Preparation', 'Break a business problem into hypotheses, segments, comparisons, assumptions, and measurable evidence.'),
('analytics-requirements-intake', 'Analytics Requirements Intake', 'Analytical Foundations & Data Preparation', 'Clarify stakeholders, scope, definitions, constraints, deadline, expected output, and acceptance criteria before analysis work starts.'),
('analytical-deliverable-types', 'Analytical Deliverable Types', 'Analytical Foundations & Data Preparation', 'Distinguish ad hoc analysis, recurring reports, dashboards, metric dictionaries, insight decks, and decision memos.'),
('stakeholder-interview-questions', 'Stakeholder Interview Questions', 'Analytical Foundations & Data Preparation', 'Ask focused questions that uncover decision context, definitions, constraints, success criteria, and risk before doing analysis.'),
('data-source-types', 'Data Source Types', 'Analytical Foundations & Data Preparation', 'Comparing transactional systems, event logs, surveys, spreadsheets, third-party data, and public datasets to choose appropriate analysis methods.'),
('data-types-and-format-standardization', 'Data Types and Format Standardization', 'Analytical Foundations & Data Preparation', 'Standardize dates, categories, currencies, text fields, and units so analysis calculations are reliable.'),
('duplicates-and-entity-resolution', 'Duplicates and Entity Resolution', 'Analytical Foundations & Data Preparation', 'Detecting duplicate records, conflicting identifiers, and entity matching issues that can distort metrics.'),
('missing-data-handling', 'Missing Data Handling', 'Analytical Foundations & Data Preparation', 'Identify why values are missing and choose appropriate handling strategies without hiding bias or uncertainty.'),
('outliers-and-robust-summaries', 'Outliers and Robust Summaries', 'Analytical Foundations & Data Preparation', 'Identify outliers, compare robust statistics, and decide whether unusual values are valid signals, quality issues, or segmentation needs.'),
('reproducible-cleaning-workflows', 'Reproducible Cleaning Workflows', 'Analytical Foundations & Data Preparation', 'Avoid one-off manual fixes by documenting transformations in SQL, Power Query, or Python scripts.'),
('text-cleaning-and-standardization', 'Text Cleaning and Standardization', 'Analytical Foundations & Data Preparation', 'Clean inconsistent names, categories, casing, spacing, punctuation, and labels before grouping or joining data.'),
('schema-drift-and-source-changes', 'Schema Drift and Source Changes', 'Analytical Foundations & Data Preparation', 'Detecting changed columns, renamed fields, type shifts, and upstream source changes before they break reports.'),
('data-dictionary-authoring', 'Data Dictionary Authoring', 'Analytical Foundations & Data Preparation', 'Documenting column definitions, units, allowed values, owners, caveats, and example records so analysis is reviewable.'),
('practical-vs-statistical-significance', 'Practical vs Statistical Significance', 'Analytical Foundations & Data Preparation', 'Separating statistically detectable changes from changes that matter enough to justify product or business action.'),
('sample-size-and-power', 'Sample Size and Power', 'Analytical Foundations & Data Preparation', 'Explaining how small samples and underpowered comparisons affect experiment interpretation and business confidence.'),
('workbook-structure-and-tables', 'Workbook Structure and Tables', 'Querying & Analysis Workflows', 'Organize raw data, analysis tabs, lookup tables, outputs, and documentation in a maintainable workbook.'),
('excel-formulas-and-functions', 'Excel Formulas and Functions', 'Querying & Analysis Workflows', 'Competency in Excel Formulas and Functions requires attention to formulas, references, structured tables, pivots, validation, auditability, and clear workbook design.'),
('lookup-and-reference-functions', 'Lookup and Reference Functions', 'Querying & Analysis Workflows', 'Using lookup patterns to enrich datasets, validate values, and combine information from multiple sheets.'),
('pivot-tables-and-summaries', 'Pivot Tables and Summaries', 'Querying & Analysis Workflows', 'Creating pivot tables to summarize, segment, filter, and explore business data efficiently.'),
('conditional-formatting-for-analysis', 'Conditional Formatting for Analysis', 'Querying & Analysis Workflows', 'Using conditional formatting to highlight outliers, thresholds, missing values, priority records, and exceptions without hiding raw data.'),
('aggregation-and-grouping', 'Aggregation and Grouping', 'Querying & Analysis Workflows', 'Using GROUP BY, aggregate functions, HAVING, and conditional aggregation to create business summaries.'),
('joins-and-relationships', 'Joins and Relationships', 'Querying & Analysis Workflows', 'Using inner, left, right, and full joins while checking row counts, duplicate inflation, and unmatched records.'),
('ctes-and-subqueries', 'CTEs and Subqueries', 'Querying & Analysis Workflows', 'Break complex analytical queries into readable steps using CTEs and subqueries.'),
('cohort-and-retention-sql', 'Cohort and Retention SQL', 'Querying & Analysis Workflows', 'Building cohort tables and retention calculations using signup periods, activity windows, joins, and window functions.'),
('sql-data-quality-checks', 'SQL Data Quality Checks', 'Querying & Analysis Workflows', 'Writing SQL checks for duplicates, nulls, invalid ranges, referential mismatches, and unexpected row counts.'),
('sql-date-and-time-analysis', 'SQL Date and Time Analysis', 'Querying & Analysis Workflows', 'Using date extraction, intervals, truncation, rolling periods, and calendar logic for time-based business analysis.'),
('notebook-workflows', 'Notebook Workflows', 'Querying & Analysis Workflows', 'Using notebooks for exploration while keeping cells ordered, assumptions documented, and outputs reproducible.'),
('pandas-time-series-analysis', 'pandas Time Series Analysis', 'Querying & Analysis Workflows', 'The practical scope of pandas Time Series Analysis includes time-aware baselines, trend and seasonality, validation windows, uncertainty, and business interpretation.'),
('python-report-automation', 'Python Report Automation', 'Querying & Analysis Workflows', 'Automating repeated data pulls, cleaning steps, charts, exports, and lightweight reporting scripts.'),
('interactive-python-data-apps', 'Interactive Python Data Apps', 'Querying & Analysis Workflows', 'Building a lightweight Streamlit or Plotly-based data app for portfolio exploration and stakeholder demos.'),
('avoiding-misleading-visuals', 'Avoiding Misleading Visuals', 'Visualization, BI & Applied Analytics', 'Identify misleading axes, cherry-picked comparisons, overplotting, bad aggregation, and unsupported causal claims.'),
('visual-design-principles', 'Visual Design Principles', 'Visualization, BI & Applied Analytics', 'Using visual hierarchy, labels, color, whitespace, and chart simplicity to reduce cognitive load.'),
('small-multiples-and-faceting', 'Small Multiples and Faceting', 'Visualization, BI & Applied Analytics', 'Using repeated chart panels to compare categories, regions, or time periods without overloading a single chart.'),
('insight-narrative', 'Insight Narrative', 'Visualization, BI & Applied Analytics', 'Writing findings that connect evidence, context, recommendation, uncertainty, and next action.'),
('presentation-delivery', 'Presentation Delivery', 'Visualization, BI & Applied Analytics', 'Present analysis in a way that answers likely stakeholder questions and separates facts, assumptions, and recommendations.'),
('dashboard-data-modeling', 'Dashboard Data Modeling', 'Visualization, BI & Applied Analytics', 'Shape data into useful dimensions, measures, calculated fields, relationships, and grain for dashboard use.'),
('dashboard-filters-and-interactivity', 'Dashboard Filters and Interactivity', 'Visualization, BI & Applied Analytics', 'Using filters, parameters, slicers, drilldowns, and tooltips without making dashboards confusing.'),
('dashboard-performance-and-refresh', 'Dashboard Performance and Refresh', 'Visualization, BI & Applied Analytics', 'Improve dashboard load time, data refresh reliability, model size, and visual complexity without losing analytical value.'),
('dashboard-ownership-and-maintenance', 'Dashboard Ownership and Maintenance', 'Visualization, BI & Applied Analytics', 'Defining dashboard owners, refresh checks, retirement rules, metric change logs, and support expectations.'),
('dax-and-calculated-measures', 'DAX and Calculated Measures', 'Visualization, BI & Applied Analytics', 'Creating basic DAX measures and understand filter context enough to debug common Power BI calculation mistakes.'),
('semantic-models-and-reusable-metrics', 'Semantic Models and Reusable Metrics', 'Visualization, BI & Applied Analytics', 'Defining reusable measures, dimensions, relationships, and business logic so dashboards stay consistent across audiences.'),
('analytics-documentation', 'Analytics Documentation', 'Visualization, BI & Applied Analytics', 'Writing README files, metric notes, data dictionaries, caveats, and dashboard usage guidance.'),
('analytics-qa-review-process', 'Analytics QA Review Process', 'Visualization, BI & Applied Analytics', 'Review queries, dashboards, charts, metric definitions, and stakeholder claims before release.'),
('regression-analysis', 'Regression Analysis', 'Visualization, BI & Applied Analytics', 'Using regression to quantify relationships, check assumptions, inspect residuals, communicate uncertainty, and avoid overstating causality.'),
('forecasting', 'Forecasting', 'Visualization, BI & Applied Analytics', 'Understanding trend, seasonality, baseline forecasts, forecast errors, and when forecasting assumptions are fragile.');
...
('chk-spreadsheet-review', 'ph-spreadsheets', 90, 'checkpoint', 'assessment', NULL, NULL, 'Spreadsheet Analysis Review', 'Practical checkpoint for Spreadsheets and Excel Analysis. The learner completes a small diagnostic task or review artifact using Workbook Structure and Tables, Excel Formulas and Functions, Lookup and Reference Functions, Pivot Tables and Summaries and records observations that can guide further practice.', 'checkpoint', 2, 'beginner', '{"reviewFocus":"Practical checkpoint for Spreadsheets and Excel Analysis. The learner completes a small diagnostic task or review artifact using Workbook Structure and Tables, Excel Formulas and Functions, Lookup and Reference Functions, Pivot Tables and Summaries and records observations that can guide further practice.","reviewCriteria":["Complete a small practical task, lab, review exercise, or worked example related to this segment.","Attach or describe the output, result, or evidence used for review.","Explain at least one mistake, trade-off, or failure mode encountered during the task.","Write the next practice action based on the result."]}'::jsonb, true, true, '["Apply selected concepts from Spreadsheets and Excel Analysis to a small practical scenario.", "Explain what worked, what failed, and which signals were used to debug or validate the result.", "Translate the result into a short next-action plan for continued learning."]'::jsonb, '["Complete a small practical task, lab, review exercise, or worked example related to this segment.", "Attach or describe the output, result, or evidence used for review.", "Explain at least one mistake, trade-off, or failure mode encountered during the task.", "Write the next practice action based on the result."]'::jsonb),
('proj-excel-sales-analysis', 'ph-spreadsheets', 100, 'project', NULL, NULL, NULL, 'Required Excel Sales Analysis Report', 'Milestone project: Analyze a sales dataset in Excel using cleaning steps, formulas, pivot tables, charts, and a short written recommendation.', 'side', 7, 'beginner', '{"whatToBuild":"Analyze a sales dataset in Excel using cleaning steps, formulas, pivot tables, charts, and a short written recommendation.","buildSteps":["Define the Excel Sales Analysis Report scenario, target user or reviewer, and the specific Spreadsheets and Excel Analysis concepts it will demonstrate.","Define the business question, audience, grain, metric formulas, and decision the artifact should support.","Prepare or clean the dataset and document assumptions, exclusions, and data-quality checks.","Build the report, dashboard, notebook, or workbook with the minimum views needed to answer the question.","Validate the numbers against source rows, spot checks, or reconciliation notes.","Write a short interpretation with caveats and recommended next actions.","Keep the scope focused enough to complete, review, and explain the a Excel Sales Analysis Report workbook, report, or dashboard with documented assumptions."],"nodeKey":"proj-excel-sales-analysis"}'::jsonb, true, true, '["Apply Excel, Spreadsheets, Data Storytelling through a focused Excel Sales Analysis Report artifact.","Explain the main design, data, tooling, workflow, or review decisions behind the project.","Validate the result with evidence that another person can inspect.","Document assumptions, limitations, and a concrete follow-up improvement."]'::jsonb, '["The a Excel Sales Analysis Report workbook, report, or dashboard with documented assumptions is available for review.","The Excel Sales Analysis Report scope, setup path, input data or scenario, and expected output are documented.","The main workflow runs or can be inspected through a notebook, repository, dashboard, prototype, report, configuration, or case study.","Validation evidence is included and directly relates to the project brief.","The notes identify trade-offs, limitations, and one next improvement without claiming mastery or job readiness."]'::jsonb),
...
('chk-sql-review', 'ph-sql-databases', 90, 'checkpoint', 'assessment', NULL, NULL, 'SQL Analysis Review', 'Practical checkpoint for SQL and Relational Data. The learner completes a small diagnostic task or review artifact using Relational Data Models, SELECT, Filtering, and Sorting, Joins and Relationships, Aggregation and Grouping and records observations that can guide further practice.', 'checkpoint', 3, 'intermediate', '{"reviewFocus":"Practical checkpoint for SQL and Relational Data. The learner completes a small diagnostic task or review artifact using Relational Data Models, SELECT, Filtering, and Sorting, Joins and Relationships, Aggregation and Grouping and records observations that can guide further practice.","reviewCriteria":["Complete a small practical task, lab, review exercise, or worked example related to this segment.","Attach or describe the output, result, or evidence used for review.","Explain at least one mistake, trade-off, or failure mode encountered during the task.","Write the next practice action based on the result."]}'::jsonb, true, true, '["Apply selected concepts from SQL and Relational Data to a small practical scenario.", "Explain what worked, what failed, and which signals were used to debug or validate the result.", "Translate the result into a short next-action plan for continued learning."]'::jsonb, '["Complete a small practical task, lab, review exercise, or worked example related to this segment.", "Attach or describe the output, result, or evidence used for review.", "Explain at least one mistake, trade-off, or failure mode encountered during the task.", "Write the next practice action based on the result."]'::jsonb),
('proj-sql-business-analysis', 'ph-sql-databases', 100, 'project', NULL, NULL, NULL, 'Required SQL Business Analysis Project', 'Milestone project: Use SQL to answer a business question with joins, aggregations, window functions, data quality checks, and a concise analysis memo.', 'side', 9, 'intermediate', '{"whatToBuild":"Use SQL to answer a business question with joins, aggregations, window functions, data quality checks, and a concise analysis memo.","buildSteps":["Define the SQL Business Analysis Project scenario and list the specific items to demonstrate: SQL queries.","Define the business question, audience, grain, metric formulas, and decision the artifact should support.","Prepare or clean the dataset and document assumptions, exclusions, and data-quality checks.","Build the report, dashboard, notebook, or workbook with the minimum views needed to answer the question.","Validate the numbers against source rows, spot checks, or reconciliation notes.","Write a short interpretation with caveats and recommended next actions.","Keep the scope focused enough to complete, review, and explain the an SQL Business Analysis Project workbook, report, or dashboard with documented assumptions."],"nodeKey":"proj-sql-business-analysis"}'::jsonb, true, true, '["Apply SQL, Data Quality, Business Metrics through a focused SQL Business Analysis Project artifact.","Explain the main design, data, tooling, workflow, or review decisions behind the project.","Validate the result with evidence that another person can inspect.","Document assumptions, limitations, and a concrete follow-up improvement."]'::jsonb, '["The an SQL Business Analysis Project workbook, report, or dashboard with documented assumptions is available for review.","The SQL Business Analysis Project scope, setup path, input data or scenario, and expected output are documented.","The main workflow runs or can be inspected through a notebook, repository, dashboard, prototype, report, configuration, or case study.","Validation evidence is included and directly relates to the project brief.","The notes identify trade-offs, limitations, and one next improvement without claiming mastery or job readiness."]'::jsonb),
...
('chk-dashboard-review', 'ph-bi-tools', 90, 'checkpoint', 'assessment', NULL, NULL, 'Dashboard Development Review Gate', 'Review checkpoint for BI Tools and Dashboard Development. The learner synthesizes completed topics such as Dashboard Data Modeling, Dashboard Filters and Interactivity, Dashboard Performance Basics, Dashboard Documentation, records evidence, and updates the learning plan before continuing.', 'checkpoint', 3, 'intermediate', '{"reviewFocus":"Review checkpoint for BI Tools and Dashboard Development. The learner synthesizes completed topics such as Dashboard Data Modeling, Dashboard Filters and Interactivity, Dashboard Performance Basics, Dashboard Documentation, records evidence, and updates the learning plan before continuing.","reviewCriteria":["Write a concise review of the main ideas from this segment.","Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.","Record open questions, weak areas, or follow-up actions.","Mark the checkpoint complete only after the review artifact and next steps are captured."]}'::jsonb, true, true, '["Explain how topics from BI Tools and Dashboard Development connect to realistic data analysis work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
('proj-bi-dashboard', 'ph-bi-tools', 100, 'project', NULL, NULL, NULL, 'Required Interactive BI Dashboard', 'Milestone project: Build an interactive dashboard in one selected BI tool with documented metrics, filters, audience, caveats, and a stakeholder-ready walkthrough.', 'side', 10, 'intermediate', '{"whatToBuild":"Build an interactive dashboard in one selected BI tool with documented metrics, filters, audience, caveats, and a stakeholder-ready walkthrough.","buildSteps":["Define the Interactive BI Dashboard scenario and list the specific items to demonstrate: dashboard decisions, metrics.","Define the business question, audience, grain, metric formulas, and decision the artifact should support.","Prepare or clean the dataset and document assumptions, exclusions, and data-quality checks.","Build the report, dashboard, notebook, or workbook with the minimum views needed to answer the question.","Validate the numbers against source rows, spot checks, or reconciliation notes.","Write a short interpretation with caveats and recommended next actions.","Keep the scope focused enough to complete, review, and explain the a Interactive BI Dashboard workbook, report, or dashboard with documented assumptions."],"nodeKey":"proj-bi-dashboard"}'::jsonb, true, true, '["Apply Dashboard Design, Data Storytelling, Business Metrics through a focused Interactive BI Dashboard artifact.","Explain the main design, data, tooling, workflow, or review decisions behind the project.","Validate the result with evidence that another person can inspect.","Document assumptions, limitations, and a concrete follow-up improvement."]'::jsonb, '["The a Interactive BI Dashboard workbook, report, or dashboard with documented assumptions is available for review.","The Interactive BI Dashboard scope, setup path, input data or scenario, and expected output are documented.","The main workflow runs or can be inspected through a notebook, repository, dashboard, prototype, report, configuration, or case study.","Validation evidence is included and directly relates to the project brief.","The notes identify trade-offs, limitations, and one next improvement without claiming mastery or job readiness."]'::jsonb),
...
('chk-python-analytics-review', 'ph-python-analytics', 90, 'checkpoint', 'assessment', NULL, NULL, 'Python Analytics Review Gate', 'Practical checkpoint for Python for Data Analysis. The learner completes a small diagnostic task or review artifact using Python Basics for Analysts, Notebook Workflows, NumPy for Analysis, pandas Data Analysis and records observations that can guide further practice.', 'checkpoint', 2, 'intermediate', '{"reviewFocus":"Practical checkpoint for Python for Data Analysis. The learner completes a small diagnostic task or review artifact using Python Basics for Analysts, Notebook Workflows, NumPy for Analysis, pandas Data Analysis and records observations that can guide further practice.","reviewCriteria":["Complete a small practical task, lab, review exercise, or worked example related to this segment.","Attach or describe the output, result, or evidence used for review.","Explain at least one mistake, trade-off, or failure mode encountered during the task.","Write the next practice action based on the result."]}'::jsonb, true, true, '["Apply selected concepts from Python for Data Analysis to a small practical scenario.", "Explain what worked, what failed, and which signals were used to debug or validate the result.", "Translate the result into a short next-action plan for continued learning."]'::jsonb, '["Complete a small practical task, lab, review exercise, or worked example related to this segment.", "Attach or describe the output, result, or evidence used for review.", "Explain at least one mistake, trade-off, or failure mode encountered during the task.", "Write the next practice action based on the result."]'::jsonb),
('proj-python-eda-notebook', 'ph-python-analytics', 100, 'project', NULL, NULL, NULL, 'Required Python EDA Notebook', 'Milestone project: Build a clean notebook that loads data, performs EDA, handles quality issues, visualizes findings, and exports a concise summary.', 'side', 8, 'intermediate', '{"whatToBuild":"Build a clean notebook that loads data, performs EDA, handles quality issues, visualizes findings, and exports a concise summary.","buildSteps":["Define the Python EDA Notebook scenario, target user or reviewer, and the specific Python for Data Analysis concepts it will demonstrate.","Define the business question, audience, grain, metric formulas, and decision the artifact should support.","Prepare or clean the dataset and document assumptions, exclusions, and data-quality checks.","Build the report, dashboard, notebook, or workbook with the minimum views needed to answer the question.","Validate the numbers against source rows, spot checks, or reconciliation notes.","Write a short interpretation with caveats and recommended next actions.","Keep the scope focused enough to complete, review, and explain the a Python EDA Notebook workbook, report, or dashboard with documented assumptions."],"nodeKey":"proj-python-eda-notebook"}'::jsonb, true, true, '["Apply Python, Exploratory Data Analysis, Data Visualization through a focused Python EDA Notebook artifact.","Explain the main design, data, tooling, workflow, or review decisions behind the project.","Validate the result with evidence that another person can inspect.","Document assumptions, limitations, and a concrete follow-up improvement."]'::jsonb, '["The a Python EDA Notebook workbook, report, or dashboard with documented assumptions is available for review.","The Python EDA Notebook scope, setup path, input data or scenario, and expected output are documented.","The main workflow runs or can be inspected through a notebook, repository, dashboard, prototype, report, configuration, or case study.","Validation evidence is included and directly relates to the project brief.","The notes identify trade-offs, limitations, and one next improvement without claiming mastery or job readiness."]'::jsonb),
...
('chk-domain-analytics-review', 'ph-domain-analytics', 90, 'checkpoint', 'assessment', NULL, NULL, 'Domain Analytics Review Gate', 'Review checkpoint for Business Domain Analytics. The learner synthesizes completed topics such as Cohort Analysis, Funnel Analysis, Product Analytics Track, Marketing Analytics Track, records evidence, and updates the learning plan before continuing.', 'checkpoint', 2, 'intermediate', '{"reviewFocus":"Review checkpoint for Business Domain Analytics. The learner synthesizes completed topics such as Cohort Analysis, Funnel Analysis, Product Analytics Track, Marketing Analytics Track, records evidence, and updates the learning plan before continuing.","reviewCriteria":["Write a concise review of the main ideas from this segment.","Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.","Record open questions, weak areas, or follow-up actions.","Mark the checkpoint complete only after the review artifact and next steps are captured."]}'::jsonb, true, true, '["Explain how topics from Business Domain Analytics connect to realistic data analysis work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
('proj-domain-analytics-case-study', 'ph-domain-analytics', 100, 'project', NULL, NULL, NULL, 'Required Domain Analytics Case Study', 'Milestone project: Choose one business domain and produce a case study with metric definitions, SQL or Python analysis, visual evidence, and recommendations.', 'side', 8, 'intermediate', '{"whatToBuild":"Choose one business domain and produce a case study with metric definitions, SQL or Python analysis, visual evidence, and recommendations.","buildSteps":["Define the Domain Analytics Case Study scenario and list the specific items to demonstrate: SQL queries.","Define the business question, audience, grain, metric formulas, and decision the artifact should support.","Prepare or clean the dataset and document assumptions, exclusions, and data-quality checks.","Build the report, dashboard, notebook, or workbook with the minimum views needed to answer the question.","Validate the numbers against source rows, spot checks, or reconciliation notes.","Write a short interpretation with caveats and recommended next actions.","Keep the scope focused enough to complete, review, and explain the a Domain Analytics Case Study workbook, report, or dashboard with documented assumptions."],"nodeKey":"proj-domain-analytics-case-study"}'::jsonb, true, true, '["Apply Business Metrics, Data Storytelling through a focused Domain Analytics Case Study artifact.","Explain the main design, data, tooling, workflow, or review decisions behind the project.","Validate the result with evidence that another person can inspect.","Document assumptions, limitations, and a concrete follow-up improvement."]'::jsonb, '["The a Domain Analytics Case Study workbook, report, or dashboard with documented assumptions is available for review.","The Domain Analytics Case Study scope, setup path, input data or scenario, and expected output are documented.","The main workflow runs or can be inspected through a notebook, repository, dashboard, prototype, report, configuration, or case study.","Validation evidence is included and directly relates to the project brief.","The notes identify trade-offs, limitations, and one next improvement without claiming mastery or job readiness."]'::jsonb),
...
('chk-advanced-awareness-review', 'ph-advanced-analytics-awareness', 90, 'checkpoint', 'assessment', NULL, NULL, 'Advanced Analytics Awareness Review Gate', 'Review checkpoint for Advanced Analytics Awareness. The learner synthesizes completed topics such as Forecasting Awareness, Segmentation and Clustering Awareness, Predictive Modeling Awareness, Anomaly Detection Awareness, records evidence, and updates the learning plan before continuing.', 'checkpoint', 2, 'advanced', '{"reviewFocus":"Review checkpoint for Advanced Analytics Awareness. The learner synthesizes completed topics such as Forecasting Awareness, Segmentation and Clustering Awareness, Predictive Modeling Awareness, Anomaly Detection Awareness, records evidence, and updates the learning plan before continuing.","reviewCriteria":["Write a concise review of the main ideas from this segment.","Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.","Record open questions, weak areas, or follow-up actions.","Mark the checkpoint complete only after the review artifact and next steps are captured."]}'::jsonb, true, true, '["Explain how topics from Advanced Analytics Awareness connect to realistic data analysis work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
('proj-advanced-analytics-brief', 'ph-advanced-analytics-awareness', 100, 'project', NULL, NULL, NULL, 'Optional Advanced Analytics Brief', 'Optional practice project: Write a brief comparing one advanced method with a simpler baseline and explain when the advanced method is or is not justified.', 'side', 4, 'advanced', '{"whatToBuild":"Write a brief comparing one advanced method with a simpler baseline and explain when the advanced method is or is not justified.","buildSteps":["Define the Advanced Analytics Brief scenario, target user or reviewer, and the specific Advanced Analytics Awareness concepts it will demonstrate.","Define the business question, audience, grain, metric formulas, and decision the artifact should support.","Prepare or clean the dataset and document assumptions, exclusions, and data-quality checks.","Build the report, dashboard, notebook, or workbook with the minimum views needed to answer the question.","Validate the numbers against source rows, spot checks, or reconciliation notes.","Write a short interpretation with caveats and recommended next actions."],"nodeKey":"proj-advanced-analytics-brief"}'::jsonb, false, true, '["Apply Statistics, Data Storytelling through a focused Advanced Analytics Brief artifact.","Explain the main design, data, tooling, workflow, or review decisions behind the project.","Validate the result with evidence that another person can inspect.","Document assumptions, limitations, and a concrete follow-up improvement."]'::jsonb, '["The a Advanced Analytics Brief workbook, report, or dashboard with documented assumptions is available for review.","The Advanced Analytics Brief scope, setup path, input data or scenario, and expected output are documented.","The main workflow runs or can be inspected through a notebook, repository, dashboard, prototype, report, configuration, or case study.","Validation evidence is included and directly relates to the project brief.","The notes identify trade-offs, limitations, and one next improvement without claiming mastery or job readiness."]'::jsonb),
...
('data-analyst-role', 'analytics-lifecycle'),
('data-analyst-role', 'business-metrics'),
('data-analyst-role', 'stakeholder-communication'),
('analytics-lifecycle', 'analytics-lifecycle'),
('analytics-lifecycle', 'analytical-deliverable-types'),
('business-questions-and-kpis', 'business-metrics'),
('business-questions-and-kpis', 'analytical-thinking'),
('data-literacy-and-ethics', 'data-literacy'),
('data-literacy-and-ethics', 'data-governance'),
('data-literacy-and-ethics', 'pii-and-sensitive-data'),
('requirements-intake', 'analytics-requirements-intake'),
('requirements-intake', 'stakeholder-interview-questions'),
('requirements-intake', 'business-metrics'),
('analytical-thinking-basics', 'analytical-thinking'),
('analytical-thinking-basics', 'business-metrics'),
('proj-analytics-question-brief', 'analytical-thinking'),
('proj-analytics-question-brief', 'analytics-requirements-intake'),
('proj-analytics-question-brief', 'business-metrics'),
('proj-analytics-question-brief', 'stakeholder-communication'),
('proj-analytics-question-brief', 'analytical-deliverable-types'),
...
('pivot-tables', 'excel'),
('pivot-tables', 'business-metrics'),
('spreadsheet-cleaning', 'data-cleaning'),
('spreadsheet-cleaning', 'excel'),
('spreadsheet-cleaning', 'data-types-and-format-standardization'),
('power-query-basics', 'power-query'),
('power-query-basics', 'data-cleaning'),
('spreadsheet-charts', 'data-visualization'),
('spreadsheet-charts', 'chart-selection'),
('spreadsheet-charts', 'excel'),
('proj-excel-sales-analysis', 'excel'),
('proj-excel-sales-analysis', 'pivot-tables-and-summaries'),
('proj-excel-sales-analysis', 'business-metrics'),
('proj-excel-sales-analysis', 'data-visualization'),
('proj-excel-sales-analysis', 'insight-narrative'),
('relational-data-models', 'relational-databases'),
('relational-data-models', 'data-modeling'),
...
('aggregation-and-grouping', 'business-metrics'),
...
('query-debugging-performance', 'query-optimization'),
('query-debugging-performance', 'sql'),
('proj-sql-business-analysis', 'sql'),
('proj-sql-business-analysis', 'joins-and-relationships'),
('proj-sql-business-analysis', 'aggregation-and-grouping'),
('proj-sql-business-analysis', 'business-metrics'),
('proj-sql-business-analysis', 'insight-narrative'),
...
('ab-test-interpretation', 'sample-size-and-power'),
('ab-test-interpretation', 'practical-vs-statistical-significance'),
('regression-awareness', 'regression-analysis'),
('regression-awareness', 'model-evaluation'),
('regression-awareness', 'statistics'),
('proj-statistical-insight-report', 'statistics'),
('proj-statistical-insight-report', 'descriptive-statistics'),
('proj-statistical-insight-report', 'hypothesis-testing'),
('proj-statistical-insight-report', 'insight-narrative'),
...
('outliers-and-anomalies', 'data-profiling'),
('outliers-and-anomalies', 'anomaly-detection'),
('data-type-and-format-standardization', 'data-types-and-format-standardization'),
('data-type-and-format-standardization', 'data-validation'),
...
('reproducible-cleaning-workflows', 'version-control-for-analysis'),
('proj-cleaning-pipeline-report', 'data-cleaning'),
('proj-cleaning-pipeline-report', 'data-quality'),
('proj-cleaning-pipeline-report', 'reproducible-cleaning-workflows'),
('proj-cleaning-pipeline-report', 'analytics-documentation'),
...
('accessibility-in-data-visualization', 'visual-design-principles'),
('dashboard-purpose-and-layout', 'dashboard-design'),
('dashboard-purpose-and-layout', 'visual-design-principles'),
('insight-narrative', 'insight-narrative'),
('insight-narrative', 'data-storytelling'),
('insight-narrative', 'business-metrics'),
...
('misleading-visuals', 'data-storytelling'),
('proj-executive-insight-deck', 'data-storytelling'),
('proj-executive-insight-deck', 'data-visualization'),
('proj-executive-insight-deck', 'insight-narrative'),
('proj-executive-insight-deck', 'presentation-delivery'),
('proj-executive-insight-deck', 'business-metrics'),
...
('dashboard-data-modeling', 'data-modeling'),
('dashboard-interactivity', 'dashboard-filters-and-interactivity'),
('dashboard-interactivity', 'dashboard-design'),
('dashboard-performance-basics', 'dashboard-performance-and-refresh'),
('dashboard-performance-basics', 'dashboard-design'),
('dashboard-documentation', 'analytics-documentation'),
('dashboard-documentation', 'dashboard-design'),
('proj-bi-dashboard', 'dashboard-design'),
('proj-bi-dashboard', 'dashboard-data-modeling'),
('proj-bi-dashboard', 'data-visualization'),
('proj-bi-dashboard', 'business-metrics'),
('proj-bi-dashboard', 'analytics-documentation'),
('python-basics-for-analysts', 'python'),
('notebook-workflows', 'notebook-workflows'),
('notebook-workflows', 'python'),
('numpy-for-analysis', 'numpy'),
...
('automation-scripts', 'python-report-automation'),
('automation-scripts', 'python'),
('proj-python-eda-notebook', 'exploratory-data-analysis'),
('proj-python-eda-notebook', 'pandas-data-analysis'),
('proj-python-eda-notebook', 'python-visualization'),
('proj-python-eda-notebook', 'notebook-workflows'),
('proj-python-eda-notebook', 'analytics-documentation'),
('product-analytics-track', 'business-metrics'),
('product-analytics-track', 'cohort-analysis'),
('product-analytics-track', 'funnel-analysis'),
('marketing-analytics-track', 'business-metrics'),
('marketing-analytics-track', 'funnel-analysis'),
('sales-analytics-track', 'business-metrics'),
('sales-analytics-track', 'aggregation-and-grouping'),
('finance-analytics-track', 'business-metrics'),
('finance-analytics-track', 'practical-vs-statistical-significance'),
('finance-analytics-track', 'forecasting'),
...
('proj-domain-analytics-case-study', 'analytical-thinking'),
('proj-domain-analytics-case-study', 'insight-narrative'),
('metric-definitions', 'semantic-models-and-reusable-metrics'),
('metric-definitions', 'business-metrics'),
('data-catalogs-lineage', 'data-governance'),
('data-catalogs-lineage', 'data-source-types'),
('data-catalogs-lineage', 'analytics-documentation'),
('privacy-sensitive-data', 'pii-and-sensitive-data'),
('privacy-sensitive-data', 'data-governance'),
...
('analytics-backlog-and-prioritization', 'analytics-requirements-intake'),
('analytics-backlog-and-prioritization', 'stakeholder-communication'),
('analytics-backlog-and-prioritization', 'business-metrics'),
('proj-governed-metric-dictionary', 'semantic-models-and-reusable-metrics'),
('proj-governed-metric-dictionary', 'data-dictionary-authoring'),
('proj-governed-metric-dictionary', 'data-governance'),
('proj-governed-metric-dictionary', 'analytics-documentation'),
('forecasting-awareness', 'forecasting'),
('forecasting-awareness', 'time-series-analysis'),
('segmentation-and-clustering-awareness', 'clustering'),
('segmentation-and-clustering-awareness', 'model-evaluation'),
('predictive-modeling-awareness', 'model-evaluation'),
('predictive-modeling-awareness', 'regression-analysis'),
...
('geospatial-analysis-awareness', 'data-source-types'),
('ai-assisted-analysis-awareness', 'ai-assisted-analysis'),
('ai-assisted-analysis-awareness', 'data-literacy'),
('proj-advanced-analytics-brief', 'model-evaluation'),
('proj-advanced-analytics-brief', 'data-storytelling'),
('proj-advanced-analytics-brief', 'analytical-thinking'),
('portfolio-project-selection', 'portfolio-communication'),
('portfolio-project-selection', 'analytical-deliverable-types'),
('case-study-writing', 'portfolio-communication'),
('case-study-writing', 'data-storytelling'),
('case-study-writing', 'analytics-documentation'),
('sql-interview-practice', 'sql'),
('sql-interview-practice', 'interview-readiness'),
('analytics-case-interviews', 'analytics-case-interviews'),
('analytics-case-interviews', 'analytical-thinking'),
('dashboard-portfolio-polish', 'dashboard-design'),
('dashboard-portfolio-polish', 'portfolio-communication'),
('dashboard-portfolio-polish', 'visual-design-principles'),
('resume-and-project-positioning', 'portfolio-communication'),
('resume-and-project-positioning', 'interview-readiness'),
('proj-data-analyst-capstone', 'sql'),
('proj-data-analyst-capstone', 'python'),
('proj-data-analyst-capstone', 'data-cleaning'),
('proj-data-analyst-capstone', 'dashboard-design'),
('proj-data-analyst-capstone', 'business-metrics'),
('proj-data-analyst-capstone', 'data-storytelling'),
('proj-data-analyst-capstone', 'portfolio-communication'),
('proj-public-portfolio-package', 'portfolio-communication'),
('proj-public-portfolio-package', 'version-control-for-analysis'),
('proj-public-portfolio-package', 'analytics-documentation'),
...
('stakeholder-interview-questions', 'analytics-requirements-intake'),
...
('spreadsheet-lookup-patterns', 'lookup-and-reference-functions'),
...
('outliers-and-robust-summaries', 'descriptive-statistics'),
...
('data-dictionary-authoring', 'analytics-documentation'),
...
('executive-summary-writing', 'insight-narrative'),
...
('dashboard-performance-and-refresh', 'analytics-qa-review-process'),
('dashboard-quality-assurance-topic', 'dashboard-quality-assurance'),
('dashboard-quality-assurance-topic', 'analytics-qa-review-process'),
...
('pandas-time-series-analysis', 'pandas-data-analysis'),
('python-report-automation', 'python-report-automation'),
('python-report-automation', 'python'),
('python-report-automation', 'analytics-documentation'),
('public-data-api-extraction', 'api-data-extraction'),
('public-data-api-extraction', 'python'),
('public-data-api-extraction', 'data-validation'),
...
('revenue-and-pricing-analysis', 'practical-vs-statistical-significance'),
('revenue-and-pricing-analysis', 'forecasting'),
...
('data-contracts-awareness', 'schema-drift-and-source-changes'),
...
('dashboard-ownership-and-maintenance', 'analytics-documentation'),
('time-series-decomposition-awareness', 'time-series-analysis'),
('time-series-decomposition-awareness', 'forecasting'),
('causal-inference-caution', 'correlation-vs-causation'),
('causal-inference-caution', 'statistics'),
('survey-analysis-basics', 'survey-analysis'),
('survey-analysis-basics', 'statistics'),
('analyst-take-home-challenges', 'interview-readiness'),
('analyst-take-home-challenges', 'analytical-thinking'),
('analyst-take-home-challenges', 'business-metrics'),
...
('capstone-presentation-walkthrough', 'presentation-delivery'),
...
('proj-spreadsheet-quality-audit', 'analytics-qa-review-process'),
('proj-sql-cohort-retention-analysis', 'sql'),
('proj-sql-cohort-retention-analysis', 'cohort-and-retention-sql'),
...
('proj-dashboard-qa-checklist', 'analytics-qa-review-process'),
('proj-dashboard-qa-checklist', 'data-validation'),
('proj-python-report-automation', 'python-report-automation'),
('proj-python-report-automation', 'python'),
('proj-python-report-automation', 'analytics-documentation'),
...
('proj-public-data-api-mini-project', 'api-data-extraction'),
('proj-public-data-api-mini-project', 'python'),
('proj-public-data-api-mini-project', 'data-validation'),
('proj-portfolio-presentation-video', 'stakeholder-communication'),
('proj-portfolio-presentation-video', 'presentation-delivery'),
('proj-portfolio-presentation-video', 'portfolio-communication')
...
('ph-advanced-analytics-awareness', 'proj-advanced-analytics-brief', 'contains', 'optional', '{"rule": "parent_contains_child"}'::jsonb),
...
-- Consolidated mappings for the complete Data Analyst roadmap.
INSERT INTO seed_node_skill VALUES
('data-analyst-role', 'analytics-lifecycle'),
('data-analyst-role', 'business-metrics'),
('data-analyst-role', 'stakeholder-communication'),
...
BEGIN
    IF EXISTS (
        ...
        JOIN seed_roadmap_map m
          ON m.roadmap_version_id = rn.roadmap_version_id
        WHERE rn.node_type NOT IN ('topic', 'choice_option', 'project')
    ) THEN
        RAISE EXCEPTION
            'Data Analyst seed contains skill mappings on disallowed node types.';
    END IF;

    IF EXISTS (
        SELECT 1
        FROM public.roadmap_node rn
        JOIN seed_roadmap_map m
          ON m.roadmap_version_id = rn.roadmap_version_id
        WHERE rn.node_type IN ('topic', 'choice_option', 'project')
          AND NOT EXISTS (
              SELECT 1
              FROM public.roadmap_node_skill rns
        ...
        RAISE EXCEPTION
            'Data Analyst seed has an eligible node without a skill mapping.';
    END IF;

    IF EXISTS (
        SELECT rn.roadmap_node_id, rns.skill_id
        FROM public.roadmap_node_skill rns
        JOIN public.roadmap_node rn
          ON rn.roadmap_node_id = rns.roadmap_node_id
        JOIN seed_roadmap_map m
          ON m.roadmap_version_id = rn.roadmap_version_id
        GROUP BY rn.roadmap_node_id, rns.skill_id
        HAVING COUNT(*) > 1
    ) THEN
        RAISE EXCEPTION
            'Data Analyst seed contains duplicate node-skill mappings.';
    END IF;

    SELECT COUNT(DISTINCT rns.skill_id)
    ...
    IF mapped_skill_count < 90 OR mapped_skill_count > 100 THEN
        RAISE EXCEPTION
            'Data Analyst roadmap must map 90-100 distinct skills; found %.',
            mapped_skill_count;
    END IF;
END $$;
...
-- Expansion summary: added 38 topics, 8 optional projects, 48 learning resources, 100 node-resource mappings, and 56 edges. Final skill mapping: 99 distinct skills across 141 eligible nodes and 365 valid node-skill mappings.
