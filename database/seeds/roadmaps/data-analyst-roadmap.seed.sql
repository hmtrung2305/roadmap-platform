...
('chk-spreadsheet-review', 'ph-spreadsheets', 90, 'checkpoint', 'assessment', NULL, NULL, 'Spreadsheet Analysis Review', 'Practical checkpoint for Spreadsheets and Excel Analysis. The learner completes a small diagnostic task or review artifact using Workbook Structure and Tables, Excel Formulas and Functions, Lookup and Reference Functions, Pivot Tables and Summaries and records observations that can guide further practice.', 'This checkpoint gives the data analysis roadmap a reviewable activity at the end of a technical segment instead of a passive completion checkbox. It does not independently verify mastery.', 'checkpoint', 'ph-spreadsheets', 2, 90, 2, 'beginner', 100, NULL, NULL, '{"generatedBy": "roadmap-platform", "checkpointType": "assessment", "checkpointPurpose": "phase_review", "reviewMode": "assessment", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Apply selected concepts from Spreadsheets and Excel Analysis to a small practical scenario.", "Explain what worked, what failed, and which signals were used to debug or validate the result.", "Translate the result into a short next-action plan for continued learning."]'::jsonb, '["Complete a small practical task, lab, review exercise, or worked example related to this segment.", "Attach or describe the output, result, or evidence used for review.", "Explain at least one mistake, trade-off, or failure mode encountered during the task.", "Write the next practice action based on the result."]'::jsonb),
('proj-excel-sales-analysis', 'ph-spreadsheets', 100, 'project', NULL, NULL, NULL, 'Required Excel Sales Analysis Report', 'Milestone project brief: Analyze a sales dataset in Excel using cleaning steps, formulas, pivot tables, charts, and a short written recommendation. Build a reviewable model or AI feature project that demonstrates the main decisions from Spreadsheets and Excel Analysis. Expected evidence includes a reproducible notebook or small service, evaluation examples with metrics or qualitative checks, and documented model, prompt, or retrieval limitations. Keep scope focused so the result can be completed, checked, and explained.', 'This required milestone project turns the surrounding Data Analyst topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'side', 'ph-spreadsheets', 2, 100, 7, 'beginner', 100, NULL, NULL, '{"generatedBy": "roadmap-platform","projectType": "milestone","projectPurpose": "milestone_practice","projectKind": "ml_ai","projectScope": "focused_milestone","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["select a small dataset or task","build the baseline or feature slice","evaluate outputs against clear examples","document failure modes and next improvements"],"expectedEvidence": ["a reproducible notebook or small service","evaluation examples with metrics or qualitative checks","documented model, prompt, or retrieval limitations"],"optionalPractice": false,"milestone": true}'::jsonb, true, true, '["Build a focused Excel Sales Analysis Report artifact that demonstrates the main concepts from Spreadsheets and Excel Analysis.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a reproducible notebook or small service, evaluation examples with metrics or qualitative checks, and documented model, prompt, or retrieval limitations.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
...
('chk-sql-review', 'ph-sql-databases', 90, 'checkpoint', 'assessment', NULL, NULL, 'SQL Analysis Review', 'Practical checkpoint for SQL and Relational Data. The learner completes a small diagnostic task or review artifact using Relational Data Models, SELECT, Filtering, and Sorting, Joins and Relationships, Aggregation and Grouping and records observations that can guide further practice.', 'This checkpoint gives the data analysis roadmap a reviewable activity at the end of a technical segment instead of a passive completion checkbox. It does not independently verify mastery.', 'checkpoint', 'ph-sql-databases', 3, 90, 3, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform", "checkpointType": "assessment", "checkpointPurpose": "phase_review", "reviewMode": "assessment", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Apply selected concepts from SQL and Relational Data to a small practical scenario.", "Explain what worked, what failed, and which signals were used to debug or validate the result.", "Translate the result into a short next-action plan for continued learning."]'::jsonb, '["Complete a small practical task, lab, review exercise, or worked example related to this segment.", "Attach or describe the output, result, or evidence used for review.", "Explain at least one mistake, trade-off, or failure mode encountered during the task.", "Write the next practice action based on the result."]'::jsonb),
('proj-sql-business-analysis', 'ph-sql-databases', 100, 'project', NULL, NULL, NULL, 'Required SQL Business Analysis Project', 'Milestone project brief: Use SQL to answer a business question with joins, aggregations, window functions, data quality checks, and a concise analysis memo. Build a reviewable database implementation lab that demonstrates the main decisions from SQL and Relational Data. Expected evidence includes schema, query, or migration artifacts, before/after evidence such as query plans or checks, and notes on consistency, performance, or recovery trade-offs. Keep scope focused so the result can be completed, checked, and explained.', 'This required milestone project turns the surrounding Data Analyst topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'side', 'ph-sql-databases', 3, 100, 9, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform","projectType": "milestone","projectPurpose": "milestone_practice","projectKind": "database_lab","projectScope": "focused_milestone","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["define the data model or query scenario","implement schema/query/migration changes","compare behavior before and after","document trade-offs"],"expectedEvidence": ["schema, query, or migration artifacts","before/after evidence such as query plans or checks","notes on consistency, performance, or recovery trade-offs"],"optionalPractice": false,"milestone": true}'::jsonb, true, true, '["Build a focused SQL Business Analysis Project artifact that demonstrates the main concepts from SQL and Relational Data.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes schema, query, or migration artifacts, before/after evidence such as query plans or checks, and notes on consistency, performance, or recovery trade-offs.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
...
('chk-statistics-review', 'ph-statistics', 90, 'checkpoint', 'assessment', NULL, NULL, 'Statistics Review Gate', 'Practical checkpoint for Statistics and Analytical Reasoning. The learner completes a small diagnostic task or review artifact using Descriptive Statistics, Distributions and Sampling, Confidence Intervals, Hypothesis Testing Basics and records observations that can guide further practice.', 'This checkpoint gives the data analysis roadmap a reviewable activity at the end of a technical segment instead of a passive completion checkbox. It does not independently verify mastery.', 'checkpoint', 'ph-statistics', 4, 90, 3, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform", "checkpointType": "assessment", "checkpointPurpose": "phase_review", "reviewMode": "assessment", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Apply selected concepts from Statistics and Analytical Reasoning to a small practical scenario.", "Explain what worked, what failed, and which signals were used to debug or validate the result.", "Translate the result into a short next-action plan for continued learning."]'::jsonb, '["Complete a small practical task, lab, review exercise, or worked example related to this segment.", "Attach or describe the output, result, or evidence used for review.", "Explain at least one mistake, trade-off, or failure mode encountered during the task.", "Write the next practice action based on the result."]'::jsonb),
('proj-statistical-insight-report', 'ph-statistics', 100, 'project', NULL, NULL, NULL, 'Required Statistical Insight Report', 'Milestone project brief: Analyze a dataset using descriptive statistics, uncertainty, group comparison, and a clear explanation of what can and cannot be concluded. Build a reviewable analysis artifact that demonstrates the main decisions from Statistics and Analytical Reasoning. Expected evidence includes a cleaned dataset or query extract, a dashboard, workbook, or analysis notebook, and a short insight summary with limitations. Keep scope focused so the result can be completed, checked, and explained.', 'This required milestone project turns the surrounding Data Analyst topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'side', 'ph-statistics', 4, 100, 7, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform","projectType": "milestone","projectPurpose": "milestone_practice","projectKind": "analytics_dashboard","projectScope": "focused_milestone","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["define the business question and target audience","prepare a minimal reliable dataset","build the view and validate key numbers","write findings and caveats"],"expectedEvidence": ["a cleaned dataset or query extract","a dashboard, workbook, or analysis notebook","a short insight summary with limitations"],"optionalPractice": false,"milestone": true}'::jsonb, true, true, '["Build a focused Statistical Insight Report artifact that demonstrates the main concepts from Statistics and Analytical Reasoning.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a cleaned dataset or query extract, a dashboard, workbook, or analysis notebook, and a short insight summary with limitations.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
...
('chk-data-cleaning-review', 'ph-data-cleaning-preparation', 90, 'checkpoint', 'review', NULL, NULL, 'Data Cleaning Review Gate', 'Review checkpoint for Data Cleaning and Preparation. The learner synthesizes completed topics such as Data Profiling, Missing Data Handling, Duplicates and Entity Resolution, Outliers and Anomalies, records evidence, and updates the learning plan before continuing.', 'This checkpoint turns the phase boundary into a reflection and evidence-review step for the data analysis roadmap rather than another unchecked content topic.', 'checkpoint', 'ph-data-cleaning-preparation', 5, 90, 3, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform", "checkpointType": "review", "checkpointPurpose": "phase_review", "reviewMode": "review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Explain how topics from Data Cleaning and Preparation connect to realistic data analysis work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
('proj-cleaning-pipeline-report', 'ph-data-cleaning-preparation', 100, 'project', NULL, NULL, NULL, 'Required Data Cleaning Pipeline Report', 'Milestone project brief: Clean a messy dataset using SQL, Power Query, or Python; document quality issues, transformation logic, validation checks, and final analysis-ready output. Build a reviewable data pipeline project that demonstrates the main decisions from Data Cleaning and Preparation. Expected evidence includes an ingest-transform-load flow, schema or data quality checks, and a run log or lineage note explaining failure handling. Keep scope focused so the result can be completed, checked, and explained.', 'This required milestone project turns the surrounding Data Analyst topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'side', 'ph-data-cleaning-preparation', 5, 100, 8, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform","projectType": "milestone","projectPurpose": "milestone_practice","projectKind": "data_pipeline","projectScope": "focused_milestone","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["define source, target, and transformation rules","implement a reproducible run path","add quality checks and failure notes","document operational assumptions"],"expectedEvidence": ["an ingest-transform-load flow","schema or data quality checks","a run log or lineage note explaining failure handling"],"optionalPractice": false,"milestone": true}'::jsonb, true, true, '["Build a focused Data Cleaning Pipeline Report artifact that demonstrates the main concepts from Data Cleaning and Preparation.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes an ingest-transform-load flow, schema or data quality checks, and a run log or lineage note explaining failure handling.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
...
('chk-visualization-review', 'ph-visualization-storytelling', 90, 'checkpoint', 'review', NULL, NULL, 'Visualization Review Gate', 'Review checkpoint for Data Visualization and Storytelling. The learner synthesizes completed topics such as Chart Selection, Visual Design Principles, Accessibility in Data Visualization, Avoiding Misleading Visuals, records evidence, and updates the learning plan before continuing.', 'This checkpoint turns the phase boundary into a reflection and evidence-review step for the data analysis roadmap rather than another unchecked content topic.', 'checkpoint', 'ph-visualization-storytelling', 6, 90, 2, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform", "checkpointType": "review", "checkpointPurpose": "phase_review", "reviewMode": "review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Explain how topics from Data Visualization and Storytelling connect to realistic data analysis work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
('proj-executive-insight-deck', 'ph-visualization-storytelling', 100, 'project', NULL, NULL, NULL, 'Required Executive Insight Deck', 'Milestone project brief: Create a short insight deck with chart choices, narrative, recommendations, limitations, and a stakeholder-ready summary. Build a reviewable analysis artifact that demonstrates the main decisions from Data Visualization and Storytelling. Expected evidence includes a cleaned dataset or query extract, a dashboard, workbook, or analysis notebook, and a short insight summary with limitations. Keep scope focused so the result can be completed, checked, and explained.', 'This required milestone project turns the surrounding Data Analyst topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'side', 'ph-visualization-storytelling', 6, 100, 7, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform","projectType": "milestone","projectPurpose": "milestone_practice","projectKind": "analytics_dashboard","projectScope": "focused_milestone","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["define the business question and target audience","prepare a minimal reliable dataset","build the view and validate key numbers","write findings and caveats"],"expectedEvidence": ["a cleaned dataset or query extract","a dashboard, workbook, or analysis notebook","a short insight summary with limitations"],"optionalPractice": false,"milestone": true}'::jsonb, true, true, '["Build a focused Executive Insight Deck artifact that demonstrates the main concepts from Data Visualization and Storytelling.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a cleaned dataset or query extract, a dashboard, workbook, or analysis notebook, and a short insight summary with limitations.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
...
('chk-dashboard-review', 'ph-bi-tools', 90, 'checkpoint', 'review', NULL, NULL, 'Dashboard Development Review Gate', 'Review checkpoint for BI Tools and Dashboard Development. The learner synthesizes completed topics such as Dashboard Data Modeling, Dashboard Filters and Interactivity, Dashboard Performance Basics, Dashboard Documentation, records evidence, and updates the learning plan before continuing.', 'This checkpoint turns the phase boundary into a reflection and evidence-review step for the data analysis roadmap rather than another unchecked content topic.', 'checkpoint', 'ph-bi-tools', 7, 90, 3, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform", "checkpointType": "review", "checkpointPurpose": "phase_review", "reviewMode": "review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Explain how topics from BI Tools and Dashboard Development connect to realistic data analysis work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
('proj-bi-dashboard', 'ph-bi-tools', 100, 'project', NULL, NULL, NULL, 'Required Interactive BI Dashboard', 'Milestone project brief: Build an interactive dashboard in one selected BI tool with documented metrics, filters, audience, caveats, and a stakeholder-ready walkthrough. Build a reviewable analysis artifact that demonstrates the main decisions from BI Tools and Dashboard Development. Expected evidence includes a cleaned dataset or query extract, a dashboard, workbook, or analysis notebook, and a short insight summary with limitations. Keep scope focused so the result can be completed, checked, and explained.', 'This required milestone project turns the surrounding Data Analyst topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'side', 'ph-bi-tools', 7, 100, 10, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform","projectType": "milestone","projectPurpose": "milestone_practice","projectKind": "analytics_dashboard","projectScope": "focused_milestone","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["define the business question and target audience","prepare a minimal reliable dataset","build the view and validate key numbers","write findings and caveats"],"expectedEvidence": ["a cleaned dataset or query extract","a dashboard, workbook, or analysis notebook","a short insight summary with limitations"],"optionalPractice": false,"milestone": true}'::jsonb, true, true, '["Build a focused Interactive BI Dashboard artifact that demonstrates the main concepts from BI Tools and Dashboard Development.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a cleaned dataset or query extract, a dashboard, workbook, or analysis notebook, and a short insight summary with limitations.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
...
('chk-python-analytics-review', 'ph-python-analytics', 90, 'checkpoint', 'assessment', NULL, NULL, 'Python Analytics Review Gate', 'Practical checkpoint for Python for Data Analysis. The learner completes a small diagnostic task or review artifact using Python Basics for Analysts, Notebook Workflows, NumPy for Analysis, pandas Data Analysis and records observations that can guide further practice.', 'This checkpoint gives the data analysis roadmap a reviewable activity at the end of a technical segment instead of a passive completion checkbox. It does not independently verify mastery.', 'checkpoint', 'ph-python-analytics', 8, 90, 2, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform", "checkpointType": "assessment", "checkpointPurpose": "phase_review", "reviewMode": "assessment", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Apply selected concepts from Python for Data Analysis to a small practical scenario.", "Explain what worked, what failed, and which signals were used to debug or validate the result.", "Translate the result into a short next-action plan for continued learning."]'::jsonb, '["Complete a small practical task, lab, review exercise, or worked example related to this segment.", "Attach or describe the output, result, or evidence used for review.", "Explain at least one mistake, trade-off, or failure mode encountered during the task.", "Write the next practice action based on the result."]'::jsonb),
('proj-python-eda-notebook', 'ph-python-analytics', 100, 'project', NULL, NULL, NULL, 'Required Python EDA Notebook', 'Milestone project brief: Build a clean notebook that loads data, performs EDA, handles quality issues, visualizes findings, and exports a concise summary. Build a reviewable analysis artifact that demonstrates the main decisions from Python for Data Analysis. Expected evidence includes a cleaned dataset or query extract, a dashboard, workbook, or analysis notebook, and a short insight summary with limitations. Keep scope focused so the result can be completed, checked, and explained.', 'This required milestone project turns the surrounding Data Analyst topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'side', 'ph-python-analytics', 8, 100, 8, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform","projectType": "milestone","projectPurpose": "milestone_practice","projectKind": "analytics_dashboard","projectScope": "focused_milestone","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["define the business question and target audience","prepare a minimal reliable dataset","build the view and validate key numbers","write findings and caveats"],"expectedEvidence": ["a cleaned dataset or query extract","a dashboard, workbook, or analysis notebook","a short insight summary with limitations"],"optionalPractice": false,"milestone": true}'::jsonb, true, true, '["Build a focused Python EDA Notebook artifact that demonstrates the main concepts from Python for Data Analysis.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a cleaned dataset or query extract, a dashboard, workbook, or analysis notebook, and a short insight summary with limitations.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
...
('chk-domain-analytics-review', 'ph-domain-analytics', 90, 'checkpoint', 'review', NULL, NULL, 'Domain Analytics Review Gate', 'Review checkpoint for Business Domain Analytics. The learner synthesizes completed topics such as Cohort Analysis, Funnel Analysis, Product Analytics Track, Marketing Analytics Track, records evidence, and updates the learning plan before continuing.', 'This checkpoint turns the phase boundary into a reflection and evidence-review step for the data analysis roadmap rather than another unchecked content topic.', 'checkpoint', 'ph-domain-analytics', 9, 90, 2, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform", "checkpointType": "review", "checkpointPurpose": "phase_review", "reviewMode": "review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Explain how topics from Business Domain Analytics connect to realistic data analysis work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
('proj-domain-analytics-case-study', 'ph-domain-analytics', 100, 'project', NULL, NULL, NULL, 'Required Domain Analytics Case Study', 'Milestone project brief: Choose one business domain and produce a case study with metric definitions, SQL or Python analysis, visual evidence, and recommendations. Build a reviewable database implementation lab that demonstrates the main decisions from Business Domain Analytics. Expected evidence includes schema, query, or migration artifacts, before/after evidence such as query plans or checks, and notes on consistency, performance, or recovery trade-offs. Keep scope focused so the result can be completed, checked, and explained.', 'This required milestone project turns the surrounding Data Analyst topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'side', 'ph-domain-analytics', 9, 100, 8, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform","projectType": "milestone","projectPurpose": "milestone_practice","projectKind": "database_lab","projectScope": "focused_milestone","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["define the data model or query scenario","implement schema/query/migration changes","compare behavior before and after","document trade-offs"],"expectedEvidence": ["schema, query, or migration artifacts","before/after evidence such as query plans or checks","notes on consistency, performance, or recovery trade-offs"],"optionalPractice": false,"milestone": true}'::jsonb, true, true, '["Build a focused Domain Analytics Case Study artifact that demonstrates the main concepts from Business Domain Analytics.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes schema, query, or migration artifacts, before/after evidence such as query plans or checks, and notes on consistency, performance, or recovery trade-offs.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
...
('chk-governance-review', 'ph-governance-collaboration', 90, 'checkpoint', 'review', NULL, NULL, 'Governance and Collaboration Review Gate', 'Practical checkpoint for Governance, Privacy, and Analytics Collaboration. The learner completes a small diagnostic task or review artifact using Metric Definitions and Semantic Consistency, Data Catalogs and Lineage, Privacy and Sensitive Data Handling, Version Control for Analysis and records observations that can guide further practice.', 'This checkpoint gives the data analysis roadmap a reviewable activity at the end of a technical segment instead of a passive completion checkbox. It does not independently verify mastery.', 'checkpoint', 'ph-governance-collaboration', 10, 90, 2, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform", "checkpointType": "review", "checkpointPurpose": "phase_review", "reviewMode": "assessment", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Apply selected concepts from Governance, Privacy, and Analytics Collaboration to a small practical scenario.", "Explain what worked, what failed, and which signals were used to debug or validate the result.", "Translate the result into a short next-action plan for continued learning."]'::jsonb, '["Complete a small practical task, lab, review exercise, or worked example related to this segment.", "Attach or describe the output, result, or evidence used for review.", "Explain at least one mistake, trade-off, or failure mode encountered during the task.", "Write the next practice action based on the result."]'::jsonb),
('proj-governed-metric-dictionary', 'ph-governance-collaboration', 100, 'project', NULL, NULL, NULL, 'Required Governed Metric Dictionary', 'Milestone project brief: Create a small governed metric dictionary with definitions, SQL logic, owners, caveats, dashboard links, and privacy notes. Build a reviewable security review artifact that demonstrates the main decisions from Governance, Privacy, and Analytics Collaboration. Expected evidence includes a scoped security review artifact, risks mapped to controls or mitigations, and clear boundaries and residual-risk notes. Keep scope focused so the result can be completed, checked, and explained.', 'This required milestone project turns the surrounding Data Analyst topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'side', 'ph-governance-collaboration', 10, 100, 6, 'intermediate', 100, NULL, NULL, '{"generatedBy": "roadmap-platform","projectType": "milestone","projectPurpose": "milestone_practice","projectKind": "security_review","projectScope": "focused_milestone","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["define a safe scope and scenario","identify risks or controls","map findings to mitigation actions","state boundaries and residual risks"],"expectedEvidence": ["a scoped security review artifact","risks mapped to controls or mitigations","clear boundaries and residual-risk notes"],"optionalPractice": false,"milestone": true}'::jsonb, true, true, '["Build a focused Governed Metric Dictionary artifact that demonstrates the main concepts from Governance, Privacy, and Analytics Collaboration.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a scoped security review artifact, risks mapped to controls or mitigations, and clear boundaries and residual-risk notes.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
...
('chk-advanced-awareness-review', 'ph-advanced-analytics-awareness', 90, 'checkpoint', 'review', NULL, NULL, 'Advanced Analytics Awareness Review Gate', 'Review checkpoint for Advanced Analytics Awareness. The learner synthesizes completed topics such as Forecasting Awareness, Segmentation and Clustering Awareness, Predictive Modeling Awareness, Anomaly Detection Awareness, records evidence, and updates the learning plan before continuing.', 'This checkpoint turns the phase boundary into a reflection and evidence-review step for the data analysis roadmap rather than another unchecked content topic.', 'checkpoint', 'ph-advanced-analytics-awareness', 11, 90, 2, 'advanced', 100, NULL, NULL, '{"generatedBy": "roadmap-platform", "checkpointType": "review", "checkpointPurpose": "phase_review", "reviewMode": "review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Explain how topics from Advanced Analytics Awareness connect to realistic data analysis work.", "Select evidence that shows attempted practice, reasoning, or implementation decisions.", "Identify which topics need review before moving to later roadmap areas."]'::jsonb, '["Write a concise review of the main ideas from this segment.", "Include one evidence artifact such as notes, a diagram, lab output, code, query results, screenshots, or a project review.", "Record open questions, weak areas, or follow-up actions.", "Mark the checkpoint complete only after the review artifact and next steps are captured."]'::jsonb),
('proj-advanced-analytics-brief', 'ph-advanced-analytics-awareness', 100, 'project', NULL, NULL, NULL, 'Optional Advanced Analytics Brief', 'Optional project brief: Write a brief comparing one advanced method with a simpler baseline and explain when the advanced method is or is not justified. Build a small, reviewable written analysis project to practice ideas from Advanced Analytics Awareness. Expected evidence includes a concise written analysis, a diagram, matrix, or decision table, and actionable recommendations with assumptions and limitations. Keep it lightweight; the goal is applied practice and clearer portfolio evidence, not a mandatory milestone.', 'This optional practice project turns the surrounding Data Analyst topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'side', 'ph-advanced-analytics-awareness', 11, 100, 4, 'advanced', 60, NULL, NULL, '{"generatedBy": "roadmap-platform","projectType": "practice","projectPurpose": "optional_practice","projectKind": "analysis_review","projectScope": "small_practice_artifact","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["define the question and scope","collect supporting observations","organize the analysis into a diagram or table","state recommendations and limitations"],"expectedEvidence": ["a concise written analysis","a diagram, matrix, or decision table","actionable recommendations with assumptions and limitations"],"optionalPractice": true,"milestone": false}'::jsonb, false, true, '["Build a small Advanced Analytics Brief artifact to practice selected concepts from Advanced Analytics Awareness.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a concise written analysis, a diagram, matrix, or decision table, and actionable recommendations with assumptions and limitations.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb),
...
('chk-final-readiness-review', 'ph-portfolio-capstone', 90, 'checkpoint', 'gate', NULL, NULL, 'Final Data Analyst Readiness Review', 'Final roadmap checkpoint for Portfolio, Interview Readiness, and Capstone. The learner reviews portfolio evidence, unresolved gaps, and next learning priorities across the data analysis path.', 'This checkpoint closes the suggested data analysis orientation path by organizing evidence and next steps. It is not an employment guarantee or formal competency certification.', 'checkpoint', 'ph-portfolio-capstone', 12, 90, 3, 'advanced', 100, NULL, NULL, '{"generatedBy": "roadmap-platform", "checkpointType": "gate", "checkpointPurpose": "phase_review", "reviewMode": "final_review", "evidenceRequired": true, "claimLimit": "orientation_and_progress_review_only_not_certification"}'::jsonb, true, true, '["Connect completed roadmap work to a coherent data analysis learning narrative.", "Review portfolio or project evidence and identify which artifacts are ready to share.", "Define remaining gaps and future specialization priorities."]'::jsonb, '["Summarize completed phases, projects, and major skill groups.", "Attach or reference portfolio evidence, project links, diagrams, reports, tests, or notes where available.", "List remaining gaps or specialization topics for future learning.", "State that the checkpoint is a planning review, not proof of job readiness."]'::jsonb),
('proj-data-analyst-capstone', 'ph-portfolio-capstone', 100, 'project', NULL, NULL, NULL, 'Required Data Analyst Capstone Project', 'Capstone project brief: Complete an end-to-end data analyst project with data cleaning, SQL or Python analysis, dashboard or insight deck, metric definitions, stakeholder recommendation, and portfolio-ready documentation. Build it as an integrated analysis artifact for the Data Analyst roadmap, with enough scope to connect multiple earlier topics from Portfolio, Interview Readiness, and Capstone. Expected evidence includes a cleaned dataset or query extract, a dashboard, workbook, or analysis notebook, and a short insight summary with limitations. Keep the implementation reviewable: define the problem, show the working path, validate the result, and document limitations rather than claiming production readiness.', 'This capstone project turns the surrounding Data Analyst topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'side', 'ph-portfolio-capstone', 12, 100, 14, 'advanced', 100, NULL, NULL, '{"generatedBy": "roadmap-platform","projectType": "milestone","projectPurpose": "capstone","projectKind": "analytics_dashboard","projectScope": "integrated_multi_topic","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["define the business question and target audience","prepare a minimal reliable dataset","build the view and validate key numbers","write findings and caveats"],"expectedEvidence": ["a cleaned dataset or query extract","a dashboard, workbook, or analysis notebook","a short insight summary with limitations"],"optionalPractice": false,"milestone": true,"capstone": true}'::jsonb, true, true, '["Plan and build an integrated Data Analyst Capstone Project that connects multiple topics from the Data Analyst roadmap.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a cleaned dataset or query extract, a dashboard, workbook, or analysis notebook, and a short insight summary with limitations.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement.","The project connects at least three earlier roadmap topics and explains how they interact."]'::jsonb),
('proj-public-portfolio-package', 'ph-portfolio-capstone', 101, 'project', NULL, NULL, NULL, 'Required Public Portfolio Package', 'Milestone project brief: Publish selected analyst projects with clean READMEs, screenshots or dashboard links, methodology notes, limitations, and interview-ready talking points. Build a reviewable portfolio evidence package that demonstrates the main decisions from Portfolio, Interview Readiness, and Capstone. Expected evidence includes a reviewable package of project evidence, clear presentation notes or README sections, and links, screenshots, or summaries that explain the work. Keep scope focused so the result can be completed, checked, and explained.', 'This required milestone project turns the surrounding Data Analyst topics into a concrete artifact. It gives the learner a clearer target, suggested build path, and review evidence without treating completion as proof of mastery or job readiness.', 'side', 'ph-portfolio-capstone', 12, 101, 6, 'advanced', 100, NULL, NULL, '{"generatedBy": "roadmap-platform","projectType": "milestone","projectPurpose": "milestone_practice","projectKind": "portfolio_review","projectScope": "focused_milestone","evidenceRequired": true,"claimLimit": "reviewable_project_evidence_only_not_mastery_or_job_readiness","suggestedSteps": ["select the evidence to include","organize it into a readable package","explain the role of each artifact","record gaps and next improvements"],"expectedEvidence": ["a reviewable package of project evidence","clear presentation notes or README sections","links, screenshots, or summaries that explain the work"],"optionalPractice": false,"milestone": true}'::jsonb, true, true, '["Build a focused Public Portfolio Package artifact that demonstrates the main concepts from Portfolio, Interview Readiness, and Capstone.","Explain the main design, data, tooling, or workflow decisions used in the project.","Validate the project with appropriate evidence such as tests, screenshots, logs, metrics, queries, or review notes.","Document setup, usage, limitations, and at least one follow-up improvement."]'::jsonb, '["A repository, notebook, dashboard, write-up, prototype, or configuration artifact is available for review.","The README or project notes state the project goal, setup steps, usage path, and expected output.","The deliverable includes a reviewable package of project evidence, clear presentation notes or README sections, and links, screenshots, or summaries that explain the work.","The learner records validation evidence such as tests, screenshots, logs, metrics, query results, playtest notes, or manual verification steps.","The review notes identify trade-offs, limitations, and one reasonable next improvement."]'::jsonb)
;
